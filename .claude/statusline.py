#!/usr/bin/env python3
"""Status line: model | branch | ctx bar | 5h bar | 7d bar | dir name"""
...
# 2. Branch name
if branch:
    parts.append(f'{BRANCH_COLOR}{branch}{R}')
...
# 6. Directory name (basename of cwd)
if cwd:
    parts.append(f'{DIM}{os.path.basename(cwd)}{R}')
...
# Leave a small safety margin (e.g. tmux pane borders, prompt padding)
