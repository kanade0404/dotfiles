...
| Claude Code skill 追加 (自作) | [kanade0404/skills](https://github.com/kanade0404/skills) に `skills/<name>/SKILL.md` を追加 → push → `rulesync-claude/rulesync.jsonc` の skills 配列に追記 | `bun run rulesync:skills:claude` + `install.sh` |
